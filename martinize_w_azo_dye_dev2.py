...
class martini22:
    ...
    def __init__(self):
        ...
        self.sidechains = {
            ...
            "TYR": [spl("SC4 SC4 SP1"),    [(0.320,5000), (0.270,None), (0.270,None),(0.270,None)],[(150,50),(150,50)],        [(0,50)]],
            "PHE": [spl("SC1 SC1 SC1"),    [(0.310,7500), (0.270,None), (0.270,None),(0.270,None)],[(150,50),(150,50)],        [(0,50)]],
            "HIS": [spl("SC4 SP1 SP1"),    [(0.320,7500), (0.270,None), (0.270,None),(0.270,None)],[(150,50),(150,50)],        [(0,50)]],
            "HIH": [spl("SC4 SP1 SQd"),    [(0.320,7500), (0.270,None), (0.270,None),(0.270,None)],[(150,50),(150,50)],        [(0,50)]],
            "ARG": [spl("N0 Qd"),          [(0.330,5000), (0.340,5000)],                           [(180,25)]],
            "LYS": [spl("C1 C1 SC1 SC1 SC1 SC1 SC1"), [(0.280,5000), (0.380,5000), (0.410,5000), (0.250,None), (0.320,5000), (0.350,5000), (0.250,None)], [(172,15), (152,15), (64,15), (139,15), (137,15), (61,15)]],
            "CYS": [spl("C5"),             [(0.310,7500)]],
            "ASP": [spl("Qa"),             [(0.320,7500)]],
            "GLU": [spl("Qa"),             [(0.400,5000)]],
            "ILE": [spl("AC1"),            [(0.310,None)]],
        ...
        "THR":     [[(0,1)]],
        "ARG":     [[(0,1),(1,2)],                         [(0,1,2)]],
        "LYS":     [[(0,1),(1,2),(2,3),(3,4),(3,5),(5,6),(6,7)],       [(0,1,2),(1,2,3),(2,3,4),(2,3,5),(3,5,6),(5,6,7)]],
        "ASP":     [[(0,1)]],
        "GLU":     [[(0,1)]],
        "CYS":     [[(0,1)]],
        "ILE":     [[(0,1)]],
...
class CoarseGrained:
    ...
    mapping = {
        ...
        "LYS":  nsplit(bb, "CB CG CD", "CE NZ CX1 OX", "CX6 CX7 HX6 HX7", "CX3 CX4 HX3 HX4", "NX1 NX2", "CY2 CY3 HY2 HY3", "CY5 CY6 HY5 HY6"),
    ...
    residue_bead_names = spl("BB SC1 SC2 SC3 SC4 SC5 SC6 SC7 SC8")
    ...
    names.update([(i, ("BB", "SC1", "SC2", "SC3", "SC4", "SC5", "SC6", "SC7", "SC8")) for i in AA3])
